...
<!-- roleQueryCameraSnInfo queryCoursePageByCondition -->
    ...
    <div v-if="isChart">
      ...
      <el-table-column align="center" prop="batteryVoltage" :label="'BatteryVoltage'"></el-table-column>
      <el-table-column align="center" prop="batteryTemperature" :label="'BatteryTemperature'"></el-table-column>
...
export default {
    ...
    created() {
      ...
      this.getCameraBetterySignalList()
    ...
    methods: {
        ...
        newgetSignal(v) {
          ...
          course.getCameraBetterySignalChart(paramsData).then(res => {
            if (res.result == false) {
              this.$message.error(res.data.message || res.data)
              return;
            }
            let resChartData = res.data
            // 使用
            let singleChartOption = {
                title: {
                },
                tooltip: {
                  trigger: 'axis'
                ...
                legend: {
                  right: '4%',
                  top: 0,
                  data: ['Battery Voltage', 'Battery Temperature']
                },
                grid: {
                  top: 20,
                  left: '3%',
                ...
                xAxis: {
                  ...
                  data: resChartData.createDate.map(function (str) {
                ...
                series: [
                  {
                    ...
                    symbol: 'circle',
                    symbolSize: 8,
                    data: resChartData.batteryVoltage
                  },
                  {
                    ...
                    symbol: 'circle',
                    symbolSize: 8,
                    data: resChartData.batteryTemperature
                  }
                ]
              }
              this.chart.setOption(singleChartOption);
        ...
        getCameraBetterySignalList() {
            ...
            this.loading = true;
            course.getCameraBetterySignalList(paramsData).then(res => {
              this.loading = false;
              if (res.result == false) {
                this.$message.error(res.data.message || res.data)
                return;
